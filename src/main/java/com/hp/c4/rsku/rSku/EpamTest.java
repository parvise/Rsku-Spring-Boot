...
public class EpamTest {
	...
	public String getPassword() throws APIException{
		...
		//System.setProperty("javax.net.ssl.trustStore", "C:/temp/src/basicpbpsdemo/cacerts.jks");
		
		//System.setProperty("javax.net.ssl.keyStore", "C:/temp/src/basicpbpsdemo/cacerts.jks");
		
		
		
		//System.setProperty("javax.net.ssl.trustStorePassword", "changeit");
		//System.setProperty("javax.net.ssl.trustStore", "C:\\\\temp\\\\src\\\\basicpbpsdemo\\\\test\\\\cacerts.jks");
		...
		//String systemName = "c4infi.inc.hpicorp.net (Db Instance: C4INFI, Port:1525)";
